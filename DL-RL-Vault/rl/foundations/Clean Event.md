...
The high-probability event that **all empirical means are simultaneously within their confidence radius of the true means**. Load-bearing for the lecture-style proof of UCB.
