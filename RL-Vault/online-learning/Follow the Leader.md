...
- **[[Stochastic Bandits|Bandit setting]] (greedy = FTL):** also $\Omega(T)$.
  *Counterexample (Celli, slide 12):* two arms. $r(a_1) \in \{0,1\}$ with prob $1/2$ each; $r(a_2) \equiv 1/4$. With prob $1/2$ the first pull of $a_1$ returns $0$ → $\hat\mu(a_1) = 0 < 1/4 = \hat\mu(a_2)$ → greedy commits to $a_2$ forever. Regret $\Delta_{a_2} = 1/4$ per round → $\Omega(T)$.
