...
- **Three regret sources** (Celli annotates these as EXPL / COMMIT / BAD ESTIMATES on slide 17): exploration cost, residual commit cost when estimates are good, and a small probability of bad estimates.
